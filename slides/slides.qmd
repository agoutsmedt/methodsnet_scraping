...
##  The seful packages for webscraping in R
...
:::{.incremental .highlight-last .small-text}
 ...
 4. Repeat the  process for parties in England and then compare the results between the UK and England.
...
We are going to list all relevant procedures.
...
Now you have listed the names of all relevant procedures, and the links to access them.
...
**5.a** Calculate the duration of each legislative process (in days) in a new column of your data frame. 
...
**5.b** What happens to the cases where the date of EP decision is not yet available?
