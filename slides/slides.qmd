...
- Uncertainty about violating the "terms of use" or "terms of service" is a "fraudulent" use of data. Often, should be motivated and not consider illegal as such. It has been also noted for instance that "Web Scraping publicly available data likely does not violate the CFAA".
- Breach of contract: should have incurred material damages.
- Trespass to chattels: when have incurred material damages.
- Trade Secrets: when used to deliberate surveillance
:::
...
- Other cases in which you need to interact with the website
  ...
  - When you need to type in a search bar
